...
*2024 – 2025*  
- Built a production-ready full-stack web application using the MERN stack.  
- Improved system performance through optimized APIs and reusable components.  
- Collaborated in an agile team with effective version control and clean architecture practices.

### **Python Full Stack Developer — Techolas Technologies**  
*2025*  
- Currently pursuing an advanced Python Full-Stack Developer program.  
- Strengthening backend architecture, frontend functionality, and modern Python development practices.  
- Working on hands-on projects to master Django, APIs, and scalable full-stack workflows.
...
- **Email:** akhilprsonl@gmail.com  
- **Phone:** +91 8590185220  
- **LinkedIn:** linkedin.com/in/akhil-madhu01  

---

Thanks for visiting my profile!  
Explore my repositories to see my work or reach out for collaboration.
